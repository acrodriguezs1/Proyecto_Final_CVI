...
private:
    ...
    float3 m_SpherePosition = float3(8.0f, 8.0f, 0.0f);
    float  m_SphereSpeed    = 5.0f;
    ...
    float3                                m_SpherePosition = float3(8.0f, 8.0f, 0.0f); // Posición inicial
    float                                 m_SphereSpeed    = 5.0f;                     // Velocidad de movimiento
